# TWC 2025: WRF-GS+
Welcome to the WRF-GS+ repository, an enhanced version of the original WRF-GS that has been accepted for TWC 2025. You can access the accompanying paper, ["Neural Representation for Wireless Radiation Field Reconstruction: A 3D Gaussian Splatting Approach"](https://arxiv.org/abs/2412.04832v4), for more details.
...
<p align="center">
  <img width="60%" src="assets/Visualization.png"/>
 
</p>

## Quantitative analysis results
<p align="center">
  <img width="60%" src="assets/SSIM.png"/>
